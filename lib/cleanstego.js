...
function writeMsgToCanvas(canvasid, msg, pass, mode) {
  ...
  switch (mode) {
    case 1:
      return writeMsgToCanvas_single(canvasid, msg, pass, true, 11, 15);
    case 2:
      return writeMsgToCanvas_single(canvasid, msg, pass, true, 9, 20);
    case 3:
      return writeMsgToCanvas_single(canvasid, msg, pass, true, 5, 30);
    case 4:
      return writeMsgToCanvas_single(canvasid, msg, pass, true, 5, 35);
    case 5:
      return writeMsgToCanvas_single(canvasid, msg, pass, true, 5, 50);
...
function readMsgFromCanvas(canvasid, pass, mode) {
  ...
  switch (mode) {
    case 1:
      return readMsgFromCanvas_single(canvasid, pass, true, 11, 15);
    case 2:
      return readMsgFromCanvas_single(canvasid, pass, true, 9, 20);
    case 3:
      return readMsgFromCanvas_single(canvasid, pass, true, 5, 30);
    case 4:
      return readMsgFromCanvas_single(canvasid, pass, true, 5, 35);
    case 5:
      return readMsgFromCanvas_single(canvasid, pass, true, 5, 50);
    case 0:
    default:
